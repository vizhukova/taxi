...
var Place = (function () {
    function Place(http, MapProvider) {
        var _this = this;
        this.http = http;
        ...
        this.MapProvider.state$.subscribe(function (newState) {
            _this.direction = newState.direction;
        });
        this.cbs = [];
    }
    ...
    Place = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [http_1.Http, map_1.MapProvider])
    ], Place);
    return Place;
})();
exports.Place = Place;
